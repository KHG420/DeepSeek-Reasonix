...
| `knowledge` | false | Search, read, list, upload, and remove documents in the project knowledge base. Use operation='search' to find relevant chunks by BM25 text retrieval; 'read' to read a specific chunk; 'list' to see all uploaded documents; 'upload' to ingest a document file; 'remove' to delete a document and all its chunks. |
